...
four_day_r_tr=four_day_r.melt(id_vars= ["data_version","target","date"],
                value_vars= ['Schätzer_Reproduktionszahl_R', 
...
four_day_r_tr.loc[four_day_r_tr.variable=='Schätzer_Reproduktionszahl_R','quantile']='NA'
...
four_day_r_tr['type'].replace({'Schätzer_Reproduktionszahl_R':'point'}, inplace=True)
...
seven_day_r_tr=seven_day_r.melt(id_vars= ["data_version","target","date"],
                value_vars= ['Schätzer_7_Tage_R_Wert', 
                             'UG_PI_7_Tage_R_Wert',
                             'OG_PI_7_Tage_R_Wert'], 
                value_name="value")
...
seven_day_r_tr.loc[seven_day_r_tr.variable=='Schätzer_7_Tage_R_Wert','quantile']='NA'
